...
class Partida:
    def __init__(self):
        ...
        self.font = font = pg.font.Font(None,30)
    ...
    def bucle_fotograma(self):
        ...
        while not game_over:
            ...
            self.pantalla_principal.fill((158, 95, 39))
    ...
    def mostrar_jugador(self):
        jugador1 = self.font.render(str("Jugador 1"), 0, (0, 0, 0))
        jugador2 = self.font.render(str("Jugador 2"), 0, (0, 0, 0))
        self.pantalla_principal.blit(jugador1, (200,10))
        self.pantalla_principal.blit(jugador2, (600,10))